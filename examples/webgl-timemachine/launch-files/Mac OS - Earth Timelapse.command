...
ARGS="--video-threads=$NUMBER_OF_PROCESSORS --allow-file-access-from-files --start-maximized --device-scale-factor=$BROWSER_SCALE_FACTOR --user-data-dir=/tmp --no-first-run"
